...
export class QuestionsController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new question with answer options for a level (requires Teacher, Center, or Agency role)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all active questions with answer options. Optionally filter by levelId',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Update question details and answer options (requires Teacher, Center, or Agency role)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Delete a question (requires Agency role only - will cascade delete all answer options)',
  })
  @ApiResponse({ status: 204, description: 'Question deleted successfully' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Only Agency can delete questions',
  })
  @ApiResponse({ status: 404, description: 'Question not found' })
